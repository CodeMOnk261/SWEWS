...
export function ElectronFluxLiveChart() {
    ...
    >
      <div className="flex items-center justify-between mb-3">
        <div>
          ...
          <p className="text-[10px] text-white/30 mt-0.5 font-mono">GOES live feed - particle flux units</p>
        </div>
      ...
      <div className="flex-1 min-h-0">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
            ...
            <Area type="monotone" dataKey="electron800kev" stroke="#4a90a4" strokeWidth={1.5} fill="url(#gradHistorical)" dot={false} isAnimationActive={false} />
            <Area type="monotone" dataKey="electron2mev" stroke="rgba(255,255,255,0.7)" strokeWidth={1.5} fill="url(#gradCurrent)" dot={false} isAnimationActive={false} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
